...
export interface EchoTwice_EchoTwiceRequest {
  message: string;
}

export interface EchoTwice_EchoTwiceResponse {
  reply: string;
  timestamp: bigint;
}

export const EchoTwice_EchoTwiceRequest = {
  encode(message: EchoTwice_EchoTwiceRequest): Buffer {
    const parts: Buffer[] = [];
  ...
  decode(buffer: Buffer): EchoTwice_EchoTwiceRequest {
    let offset = 0;
    let message = '';
...
export const EchoTwice_EchoTwiceResponse = {
  encode(message: EchoTwice_EchoTwiceResponse): Buffer {
    const parts: Buffer[] = [];
  ...
  decode(buffer: Buffer): EchoTwice_EchoTwiceResponse {
    let offset = 0;
    let reply = '';
    let timestamp = 0n;
