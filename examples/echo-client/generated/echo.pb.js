...
exports.Echo_EchoRequest = exports.Echo_EchoResponse = void 0;

const Echo_EchoRequest = {
  encode(message) {
    const parts = [];
...
exports.Echo_EchoRequest = Echo_EchoRequest;

const Echo_EchoResponse = {
  encode(message) {
    const parts = [];
...
exports.Echo_EchoResponse = Echo_EchoResponse;
